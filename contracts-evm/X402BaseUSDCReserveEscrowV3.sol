...
contract X402BaseUSDCReserveEscrowV3 is AccessControl, Pausable, ReentrancyGuard {
    ...
    function reserveExactWithAuthorizationSplit(
        ...
        _reservations[key] = Reservation({
            ...
            protocolFeePayTo: protocolFeePayTo,
    ...
    function releaseReservedPayment(
        ...
        emit PaymentReleased(
            ...
            requestIdHash,
            paymentIdHash,
            reservation.sellerPayTo,
            reservation.protocolFeePayTo,
            reservation.sellerAmount,
            reservation.protocolFeeAmount,
            reservation.feeBps,
        ...
        whenNotPaused
    {
        ...
        usdc.safeTransfer(reservation.payer, reservation.grossAmount);

        emit PaymentRefunded(key, requestIdHash, paymentIdHash, reservation.payer, reservation.grossAmount);
    }
