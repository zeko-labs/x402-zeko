...
contract X402BaseUSDCReserveEscrowV4 is AccessControl, Pausable, ReentrancyGuard {
    ...
    event PaymentRefunded(
        ...
        bytes32 indexed paymentIdHash,
        address payer,
        uint256 sellerRefundAmount,
        uint256 protocolFeeAmountRetained
    );
    ...
    function reserveExactWithAuthorizationSplitImmediateFee(
        ...
        if (protocolFeeAmount > 0) {
            usdc.safeTransfer(protocolFeePayTo, protocolFeeAmount);
        }
        ...
        whenNotPaused
    {
        ...
        usdc.safeTransfer(reservation.payer, reservation.sellerAmount);
