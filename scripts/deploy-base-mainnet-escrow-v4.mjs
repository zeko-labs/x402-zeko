...
import { deployEscrowV4, optionalEnv, requiredEnv } from "./lib/deploy-escrow-v4.mjs";
...
const adminAddress = optionalEnv("X402_BASE_MAINNET_ESCROW_ADMIN") ?? requiredEnv("X402_BASE_MAINNET_ESCROW_ADMIN");
const releaserAddress =
  optionalEnv("X402_BASE_MAINNET_ESCROW_RELEASER") ?? requiredEnv("X402_BASE_MAINNET_ESCROW_RELEASER");

await deployEscrowV4({
